(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("intuitPaymentSDK", [], factory);
	else if(typeof exports === 'object')
		exports["intuitPaymentSDK"] = factory();
	else
		root["intuitPaymentSDK"] = factory();
...
var _notImplementedError = __webpack_require__(53);
...
var Base = function () {
  ...
  _createClass(Base, [{
    ...
    key: 'createFromToken',
    value: function createFromToken(info) {
      throw new _notImplementedError2.default();
    }
  }, {
    key: 'get',
...
var _bankAccount = __webpack_require__(18);

var _bankAccount2 = _interopRequireDefault(_bankAccount);

var _creditCard = __webpack_require__(54);
...
var Intuit = function () {
  function Intuit(args) {
    _classCallCheck(this, Intuit);
  ...
  _createClass(Intuit, [{
    key: 'BankAccount',
    value: function BankAccount(accessToken, realmID) {
      return new _bankAccount2.default({
    ...
    key: 'CreditCard',
    value: function CreditCard(accessToken, realmID) {
      return new _creditCard2.default({
        version: this.version,
        production: this.production,
        accessToken: accessToken,
        realmID: realmID
    ...
    key: 'Token',
    value: function Token(accessToken, realmID) {
...
var BankAccount = function (_Base) {
  _inherits(BankAccount, _Base);

  function BankAccount() {
    _classCallCheck(this, BankAccount);

    return _possibleConstructorReturn(this, (BankAccount.__proto__ || Object.getPrototypeOf(BankAccount)).apply(this, arguments));
  }
  ...
  _createClass(BankAccount, [{
     ...
     */
    value: function create(bank, customerID) {
    ...
    key: 'createFromToken',
    value: function createFromToken(token, customerID) {
    ...
    key: 'remove',
    value: function remove(bankID, customerID) {
    ...
    key: 'get',
    value: function get(bankID, customerID) {
    ...
    key: 'chargeByToken',
    value: function chargeByToken(token, amount, description) {
    ...
    key: 'chargeByID',
    value: function chargeByID(bankID, amount, description) {
      return this.request('POST', '/payments/echecks', {
    ...
    key: 'receipt',
    value: function receipt(checkID) {
...
var NotImplementedError = function (_Error) {
  ...
  function NotImplementedError() {
    var message = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'This method is abstract and has not been overriden yet. Check the stack trace';
...
var CreditCard = function (_Base) {
  _inherits(CreditCard, _Base);
  ...
  _createClass(CreditCard, [{
     ...
     * @return {Promise} promise containing network response object
     */
    value: function create(card, customerID) {
    ...
    key: 'remove',
    value: function remove(cardID, customerID) {
    ...
    key: 'get',
    value: function get(cardID, customerID) {
    ...
    key: 'chargeByID',
    value: function chargeByID(cardID, amount, description) {
      var currency = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'USD';
    ...
    key: 'receipt',
    value: function receipt(chargeID) {
    ...
    key: 'capture',
    value: function capture(chargeID, amount) {
    ...
    key: 'getRefund',
    value: function getRefund(chargeID, refundID) {
    ...
    key: 'refund',
    value: function refund(chargeID, amount, reason) {
...
//# sourceMappingURL=intuitPaymentSDK.js.map