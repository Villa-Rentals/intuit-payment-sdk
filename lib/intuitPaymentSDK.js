...
var _bankAccount = __webpack_require__(1);

var _bankAccount2 = _interopRequireDefault(_bankAccount);

var _eCheck = __webpack_require__(2);

var _eCheck2 = _interopRequireDefault(_eCheck);

var _creditCard = __webpack_require__(3);
...
var Intuit = function () {
  ...
  _createClass(Intuit, [{
    key: 'BankAccount',
    value: function BankAccount(accessToken) {
    ...
    key: 'ECheck',
    value: function ECheck(accessToken) {
      return new _eCheck2.default({
        version: this.version,
        production: this.production,
        accessToken: accessToken
      });
    ...
    key: 'CreditCard',
    value: function CreditCard(accessToken) {
...
var BankAccount = function (_Base) {
  ...
  _createClass(BankAccount, [{
     ...
     */
    value: function create(bank, customerID, requestID) {
    ...
    key: 'createFromToken',
    value: function createFromToken(token, customerID, requestID) {
    ...
    key: 'remove',
    value: function remove(bankID, customerID, requestID) {
...
var ECheck = function (_Base) {
  _inherits(ECheck, _Base);

  function ECheck() {
    _classCallCheck(this, ECheck);

    return _possibleConstructorReturn(this, (ECheck.__proto__ || Object.getPrototypeOf(ECheck)).apply(this, arguments));
  }
...
var CreditCard = function (_Base) {
  ...
  _createClass(CreditCard, [{
     ...
     * @return {Promise} promise containing network response object
     */
    value: function create(card, customerID, requestID) {
    ...
    key: 'remove',
    value: function remove(cardID, customerID, requestID) {
...
var _notImplementedError = __webpack_require__(37);
